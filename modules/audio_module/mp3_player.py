...
class MP3Player:
    ...
    def draw(self, screen, width, height):
        """Draw the MP3 player with dynamic positioning based on screen size."""
        if not self.songs:
            print("No songs available, not drawing MP3 player")
            return {}
            
        # Calculate dynamic positions based on screen size
        # MP3 player should be positioned in the bottom-right corner
        mp3_width = 260
        mp3_height = 300
        margin = 20
        
        # Position in bottom-right corner
        background_pos = {"x": width - mp3_width - margin, "y": height - mp3_height - margin}
        ...
        # Song info display removed for cleaner look
        pass
